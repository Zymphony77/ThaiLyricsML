# Start creating and then training the model
...
# Initialize random value between -epsilon and epsilon
...
# # Numerical gradient - Gradient checking [Note: VERY SLOW]
# diff = 1e-4
# cost, t1grad, t2grad = nnCostFunction(training, result, theta1, theta2, 1, 1)
# for i in range(2):
# 	for j in range(2):
# 		print(i, j)
# 		theta1[i,j] += diff
# 		costP = nnCostFunction(training, result, theta1, theta2, 1, 0)
# 		print(costP)
# 		theta1[i,j] -= 2*diff
# 		costM = nnCostFunction(training, result, theta1, theta2, 1, 0)
# 		print(costM)
# 		theta1[i,j] += diff
# 		print(t1grad[i,j], ">>", (costP - costM) / (2*diff))
...
# 		print(costM)
# 		theta2[i,j] += diff
# 		print(t2grad[i,j], ">>", (costP - costM) / (2*diff))
